    ...
    // extends Fixture implements OrderedFixtureInterface
{
    ...
    const FLATRATES = [
        ...
        ['price' => 50, 'label' => "Paris (intra-muros)",                   'pickup_included' => 1,'region_code' => '11'],
        ...
        ['price' => 35, 'label' => "Lyon (intra-muros - Gares)",            'pickup_included' => 1,'region_code' => '84'],
        ...
        ['price' => 45, 'label' => "Nice (intra-muros)",                    'pickup_included' => 1,'region_code' => '93'],
        ...
        ['price' => 35, 'label' => "Montpellier (intra-muros)",             'pickup_included' => 1,'region_code' => '76'],
        // ....
    ];
